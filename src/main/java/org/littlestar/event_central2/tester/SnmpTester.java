...
public class SnmpTester {
	...
	public SnmpTester(String protocol) throws Exception {
	...
	public ResponseEvent send(PDU pdu, CommunityTarget target) throws Exception {
		return snmp.send(pdu, target);
	}
	
	public ResponseEvent send(PDU pdu, String tAddr, int port, String community, int targetVersion) throws Exception {
	...
	public ResponseEvent send(PDU pdu, String tAddr, int port, String community) throws Exception {
		return send(pdu, tAddr, port, community, SnmpConstants.version2c);
	}
	
	public ResponseEvent send(PDU pdu, String tAddr, String community) throws Exception {
		return send(pdu, tAddr, PORT, community);
	}
	
	public ResponseEvent send(PDU pdu, String tAddr) throws Exception {
